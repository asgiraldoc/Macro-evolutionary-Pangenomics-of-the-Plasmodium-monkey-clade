...
We analyzed the "Simian Clade" of *Plasmodium*, focusing on the structural differences between species and assessing genome assembly quality.
...
* **P. knowlesi:** H strain, A1H1.
* **P. cynomolgi:** M strain.
* **P. vivax:** strains SY43, SY56, MHC087, PAM, W1, P01.

## Tools Used

1.  **MUM&Co** (v1.3.4): For whole-genome alignment and synteny.
...
* **Results:** The alignment shows identical collinearity for most chromosomes (except corrections in Chr 12 and 14). However, we observe high "fragmentation" in the alignment. This is not structural variation but rather the massive correction of indels introduced by the polishing step. This confirms the qualitative superiority of the V2 assembly.
...
* **Results:** MUM&Co provided very granular synteny results, outperforming gene-centric tools like R's GENESPACE. We were able to detect syntenic blocks in both intergenic and intragenic regions.
...
* **Variable Regions:** The "shell" of the pangenome is enriched with multigene families (virulence factors), showing where the species diverge most.
...
We evaluated both tools for their utility in macro-evolutionary studies within Galaxy:
...
**Summary:**
While these tools are designed for populations, they are highly effective for inter-species analysis. **MUM&Co** is ideal for quick synteny checks, while **PGGB** is better suited for deep structural analysis and dissecting complex gene families.
